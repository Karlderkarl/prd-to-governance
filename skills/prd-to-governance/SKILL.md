...
> 📣 **New skill: [`Karlderkarl/governance-to-automation`](https://github.com/Karlderkarl/governance-to-automation)**
> This is the recommended follow-up to `prd-to-governance`. It turns your governance files
> (SOUL.md, AGENTS.md, CLAUDE.md, MEMORY.md) into running automation. Install with:
